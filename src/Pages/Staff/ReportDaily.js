...
export default class ReportDaily extends React.Component {
      ...
      <div>
        ...
        <section className="page-content">
          <div className="page-search-area">
            <div id="report_by_day" className="page-search-form">
              ...
              <div id="booking" className="form-group">
                <label className="form-label">By Day</label>
                <input className="form-input form-date" type="date" placeholder="Booking Day" name="field_day" ></input>
              </div>
