...
export default class ReportWeekly extends React.Component {
      ...
      <div>
        ...
        <section className="page-content">
          <div className="page-search-area">
            <div id="report_by_week" className="page-search-form">
              ...
              <div id="by_date" className="form-group">
                <label className="form-label">By Week</label>
                <input className="form-input" type="text" name="field_week" placeholder="Week"/>
