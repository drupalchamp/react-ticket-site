      ...
      <div>
        ...
        <section className="page-content">
          <div className="page-search-area">
            <div id="report_by_month" className="page-search-form">
              ...
              <div id="booking" className="form-group">
                <label className="form-label">By Month</label>
                <input className="form-input form-date" type="date" placeholder="Booking Month" name="field_month"></input>
              </div>
